  ...
  return (
    <div className='grid justify-items-center mt-16 mx-32'>
        {contents.map((content , index) => (
         ...
         <div className='mt-16 h-auto w-3/4 border-2 border-fuchsia-400 rounded-md dark:bg-navBar text-left p-6 font-light text-lg dark:border-fuchsia-400 hover:opacity-80'>
